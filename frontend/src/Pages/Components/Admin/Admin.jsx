      ...
      <div className="flex items-start justify-center gap-20">
        <div className="rounded-md">
          ...
          {StudentData && StudentData.length > 0 ? (
            ...
            <p className="text-white mt-4">No pending student requests</p>
          )}
        </div>
        ...
        <div className="rounded-md">
          ...
          {TeacherData && TeacherData.length > 0 ? (
            ...
            <p className="text-white mt-4">No pending teacher requests</p>
          )}
        </div>
        ...
        <div className="rounded-md">
          ...
          {TeacherData && TeacherData.length > 0 ? (
            ...
            <p className="text-white mt-4">No rejected requests</p>
          )}
        </div>
      </div>
    </div>
